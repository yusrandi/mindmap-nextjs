    ...
    <Navbar onMenuOpenChange={setIsMenuOpen} className="mt-2">
      ...
      <NavbarContent className="hidden sm:flex gap-6" justify="center">
        <NavbarItem isActive={segment === "(home)"}>
          <Link
            color={segment === "(home)" ? "secondary" : "foreground"}
            href="/"
            as={NextLink}
          >
            Home
        ...
        <NavbarItem isActive={segment === "user"}>
          <Link
            color={segment === "user" ? "secondary" : "foreground"}
            href="/user"
            as={NextLink}
          >
            Users
        ...
        {/* <NavbarItem isActive={segment === "history"}>
          <Link
            color={segment === "history" ? "secondary" : "foreground"}
            href="/history"
            as={NextLink}
          >
            Histories
        ...
        <NavbarItem isActive={segment === "menu"}>
          <Link
            color={segment === "menu" ? "secondary" : "foreground"}
            href="/menu"
            as={NextLink}
          >
            Materi & Games
        ...
        <NavbarMenuItem>
          <Link
            style={{
              minWidth: "100%",
              color: "inherit",
              fontWeight: segment === "user" ? "bold" : "normal",
            }}
            href="/user"
            as={NextLink}
          >
        ...
        {/* <NavbarMenuItem>
          <Link
            style={{
              minWidth: "100%",
              color: "inherit",
              fontWeight: segment === "history" ? "bold" : "normal",
            }}
            href="/history"
            as={NextLink}
          >
        ...
        <NavbarMenuItem>
          <Link
            style={{
              minWidth: "100%",
              color: "inherit",
              fontWeight: segment === "menu" ? "bold" : "normal",
            }}
            href="/menu"
            as={NextLink}
          >
